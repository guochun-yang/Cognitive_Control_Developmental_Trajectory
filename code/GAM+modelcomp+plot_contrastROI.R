...
source('H:/meta_development/Results_R1/SDM/scripts/pmtx_adjust.R')
...
savedir = shortPathName("H:/meta_development/Results_R1/SDM/mean/analysis_Adult-ChildOld/plot/blob_adult-chilolder_good/")
...
for (i in 1:nfile) {
  ...
  res.base <- 
    rma(beta, 
        var, 
        mods = ~ TaskCode_1 + TaskCode_2 + TaskCode_3 + HandnessCode_1 + HandnessCode_2 + ContrastCode_1 + ContrastCode_2 + ErrorTrialCode_1,
        data = data2,
